/**
=========================================================
* KidsLink Teacher Dashboard - Complaints and Feedback
=========================================================
*/
...
function ComplaintsAndFeedback() {
  ...
  const loadComplaintTypes = async () => {
    ...
    try {
      const result = await teacherService.getComplaintTypes();
      if (result.success) {
  ...
  const loadComplaints = async () => {
    ...
    try {
      const result = await teacherService.getMyComplaints();
      if (result.success) {
  ...
  const handleSubmitComplaint = async () => {
    ...
    try {
      const result = await teacherService.createComplaint(
